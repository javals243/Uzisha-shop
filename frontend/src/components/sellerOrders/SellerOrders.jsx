...
import FinancialSheet from "../Shop/FinancialSheet";
import SellerOrdersSheet from "../Shop/SellerOrdersSheet";

const SellerOrders = ({ children, good }) => {
  const [showModal, setShowModal] = React.useState(false);

  const handleShow = () => setShowModal(true);

  const componentRef = useRef();
  console.log("this is your order ", good);
  const pageStyle = `
   @media print {
      @page {
         size: a5 portrait;
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                {/*body*/}
                <SellerOrdersSheet good={good} ref={componentRef} />
                {/*footer*/}
